...
const App = () => {
  ...
  function updateSelectionStyle(nextBackground, selectionId) {
    setColors((prev) => ({
      ...prev,
      [selectionId]: nextBackground.background,
    }));
  }

  const applyColor = (selectedId) => {
    updateSelectionStyle(nextBackground, selectedId);
  };
